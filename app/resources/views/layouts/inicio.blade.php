                ...
                <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                    ...
                    <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                        @if (Route::has('login'))
                                ...
                                @auth
                                    <a href="{{ url('/dashboard') }}" class="font-medium text-gray-500 hover:text-gray-900">Dashboard</a>
{{--                                <a href="{{ url('/dashboard') }}" class="font-medium text-indigo-600 hover:text-indigo-500">Finalizar sesxión</a>--}}
                                @else
                                    <a href="{{ route('login') }}" class="font-medium text-indigo-600 hover:text-indigo-500">Login</a>

                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="font-medium text-gray-500 hover:text-gray-900">Registrarse</a>
                                    @endif
                                @endauth
